...
这个方法要比手动改 `/ico vscode-icons:file-type-vite;vite.config.ts` 和 `/ico vscode-icons:file-type-typescript-official;tsconfig.json` 方便的多，感谢库作者
...
新建 `/ico vscode-icons:file-type-vite;vite.config.ts`，编写官网给的内容
...
编辑 `/ico vscode-icons:file-type-json;package.json`
...
初始化 `/ico vscode-icons:file-type-light-toml;rsw.toml`
...
编辑 `/ico vscode-icons:file-type-light-toml;rsw.toml`
...
`/ico vscode-icons:file-type-html;index.html` 部分
...
`/ico vscode-icons:file-type-typescript-official;/src/main.ts` 部分
