...
description: 为什么贝塞尔曲线着色并不是扁的，而是有厚度的？无论我怎样旋转视角都一样？
---
...
![[_public/updater/DifferenceBetweenLines.mp4]]
...
![[_public/gl/line-shader.excalidraw.svg]]
...
![[_public/gl/pentagon-out.excalidraw.svg]]

![[_public/gl/pentagon-in.excalidraw.svg]]
...
这个函数实际上就是通过相机距离、光源位置等参数，来计算最终要渲染到画布上的颜色。感兴趣的读者，可以在 [`/ico vscode-icons:default-folder-opened;inserts`](https://github.com/3b1b/manim/tree/master/manimlib/shaders/inserts) 中查看，这个文件夹里面还包含了不少有用的工具函数。
